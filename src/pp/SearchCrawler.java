...
public class SearchCrawler extends JFrame {
	...
	// Search stats GUI controls.
	    JLabel crawlingLabel2;
	    JLabel crawledLabel2;
	    JLabel toCrawlLabel2;
	    JProgressBar progressBar;
	    JLabel matchesLabel2;
	...
	// Set application title.
	        setTitle("Search Crawler by ( Maaz , A.Basit , Haziq and Tanseer )");
	// Set window size.
	        setSize(600, 600);
	...
	// Retrieve host's disallow list from cache.
	        ArrayList<String> disallowList
	                = (ArrayList<String>) disallowListCache.get(host);
	...
	matched in the given page contents. */
	    ...
	    boolean searchStringMatches(String pageContents, String searchString,boolean caseSensitive) {
